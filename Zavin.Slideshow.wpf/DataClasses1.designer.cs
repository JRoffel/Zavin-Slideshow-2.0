...
namespace Zavin.Slideshow.wpf
{
    ...
    partial void Deletewachtboek(wachtboek instance);
		...
		public DataClasses1DataContext() : 
				base(global::Zavin.Slideshow.wpf.Properties.Settings.Default.mczavidordConnectionString8, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<infoper> infopers
		{
			get
			{
	...
	public partial class acaf : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<decimal> _acaf_lacal;
    ...
    partial void Onacaf_lacalChanging(System.Nullable<decimal> value);
    partial void Onacaf_lacalChanged();
    ...
    partial void Onacaf_rowidChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_acaf_lacal", DbType="Decimal(8,0)")]
		public System.Nullable<decimal> acaf_lacal
		{
			get
			{
				return this._acaf_lacal;
			}
			set
			{
				if ((this._acaf_lacal != value))
				{
					this.Onacaf_lacalChanging(value);
					this.SendPropertyChanging();
					this._acaf_lacal = value;
					this.SendPropertyChanged("acaf_lacal");
					this.Onacaf_lacalChanged();
				}
			}
		}
    ...
    partial void Onwb_crft7Changing(string value);
    partial void Onwb_crft7Changed();
    ...
    partial void Onwb_crft8Changing(string value);
    partial void Onwb_crft8Changed();
    ...
    partial void Onwb_rowidChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_wb_crft7", DbType="Char(8)")]
		public string wb_crft7
		{
			get
			{
				return this._wb_crft7;
			}
			set
			{
				if ((this._wb_crft7 != value))
				{
					this.Onwb_crft7Changing(value);
					this.SendPropertyChanging();
					this._wb_crft7 = value;
					this.SendPropertyChanged("wb_crft7");
					this.Onwb_crft7Changed();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_wb_crft8", DbType="Char(8)")]
		public string wb_crft8
		{
			get
			{
				return this._wb_crft8;
			}
			set
			{
				if ((this._wb_crft8 != value))
				{
					this.Onwb_crft8Changing(value);
					this.SendPropertyChanging();
					this._wb_crft8 = value;
					this.SendPropertyChanged("wb_crft8");
					this.Onwb_crft8Changed();
				}
			}
		}
